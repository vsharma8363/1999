...
public class InstagramScreen extends SetupProfile {
                    ...
                    StringRequest request = new StringRequest(Request.Method.POST, postUrl, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            try {
                                ...
                                String instagramUID = json.get("user_id").toString();
                                String instagramToken = json.get("access_token").toString();
                                UserInterface.setInstagramUID(instagramUID);
                                UserInterface.setInstagramToken(instagramToken);
    ...
    private String getInstagramHandle() {
        UserInterface.getInstagramToken();
        UserInterface.getInstagramUID();
        return null;
    }
